...
function Signup(props) {
  ...
  return (
    <div className="flex -mt-24 min-h-screen bg-gradient-to-r  from-green-300 via-blue-500 to-purple-600 dark:from-gray-700 dark:via-gray-900 dark:to-black justify-center items-center">
