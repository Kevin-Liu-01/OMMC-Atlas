...
export default function NotFound(props) {
  return (
    <div
      className={
        (props.dark ? "dark" : "") +
        " min-h-screen bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 dark:from-red-500 dark:to-red-800"
      }
    >
      <header className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 text-center md:text-left md:pt-24">
        <div className="grid md:grid-cols-2 md:gap-8">
          <div className="my-auto ">
            <div className="text-3xl lg:text-4xl font-bold text-white pb-6 lg:pb-8">
            ...
            <a href="/" className=" md:mr-4 ">
              <button className="hover:scale-105 transform duration-150 ease-in-out px-8 py-3 border border-transparent text-base font-medium rounded-xl text-red-900 bg-gradient-to-r from-orange-300 to-red-300 md:py-4 md:text-lg md:px-10 select-none">
                Back to home
              </button>
            </a>
          </div>
