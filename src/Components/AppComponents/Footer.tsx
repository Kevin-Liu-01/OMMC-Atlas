      ...
      <div className="max-w-7xl mx-auto flex justify-center flex-row-1">
        <div className="my-auto flex flex-col mr-4 md:mr-5 relative">
          <img
            ...
            href="/"
          />
          <div className="absolute left-0 right-1/2  top-0 bottom-0 inset-0 opacity-[35%] dark:opacity-[40%] transform-gpu animate-blob1 rounded-full blur-2xl bg-red-700 "></div>
        </div>
